...
from boundaries.models import Timezone, timezone_mapping



class Command(BaseCommand):
    args = ''
    help = 'loads the Natural Earth Timezones Shapefile'
    ...
    def handle(self, *args, **options):
        ...
        if self.success == True:
            self.stdout.write('Successfully loaded the boundaries for Natural Earth Timezone boundaries.')
...
def load_all_data():
    ...
    ds = DataSource('shapefiles/world/tz_world_mp.shp')
